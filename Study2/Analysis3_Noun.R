...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model1")
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model2")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model3")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model4")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model5")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model6")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model7")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model8")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model9")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model10")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model11")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model12")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model13")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model14")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model15")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model16")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model_selected")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
## make a data list for stan
df_st <- scale(df[2:7]) %>% as.data.frame() %>% mutate(diff_noun=df$diff_noun, diff_noun=df$diff_noun)
data <- list(Nrow = nrow(df_st),
             diff_words = df_st$diff_noun,
             X1 = df_st$AgeM,
             X2 = df_st$Match,
             X3 = df_st$Mis,
             X4 = df_st$ObjDiff,
...
output_dir <- here("Study2", "MCMCSamples", "Analysis3_Noun", "model_selected_standardized")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
