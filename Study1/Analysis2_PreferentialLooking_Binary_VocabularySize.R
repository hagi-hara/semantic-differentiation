...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_VocabularySize", "model1")
...
str_c(output_dir,
  ...
  read_stan_csv() -> fit1
print(fit1, pars = c("beta0", "beta1", "beta2", "beta3", "sigma"), probs = c(0.5, 0.025, 0.975), digits=3)
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_VocabularySize", "model2")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_VocabularySize", "model3")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_VocabularySize", "model4")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_VocabularySize", "model5")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_VocabularySize", "model_selected")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
ggsave(file = here("Study1", "Figures", "Analysis2_PreferentialLooking_Binary_VocabularySize.png"), plot = gp, dpi = 350, width = 5.1, height = 4.9) # Figure S2b(left)
