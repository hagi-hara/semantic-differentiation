...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_Pointing_Binary_VocabularySize", "model1")
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_Pointing_Binary_VocabularySize", "model2")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_Pointing_Binary_VocabularySize", "model3")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_Pointing_Binary_VocabularySize", "model4")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_Pointing_Binary_VocabularySize", "model5")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_Pointing_Binary_VocabularySize", "model_selected")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
df %>% 
  ...
  labs(x = "Total vocabulary size", y = "Proportion of correct responses (pointing)") +
...
ggsave(file = here("Study1", "Figures", "Analysis2_Pointing_Binary_VocabularySize.png"), plot = gp, dpi = 350, width = 5.1, height = 4.9) # Figure S2b(right)
