...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_Age", "model1")
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_Age", "model2")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_Age", "model3")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_Age", "model4")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_Age", "model5")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
output_dir <- here("Study1", "MCMCSamples", "Analysis2_PreferentialLooking_Binary_Age", "model_selected")
if (!dir.exists(output_dir)){
  dir.create(output_dir, recursive = TRUE)
}
...
ggsave(file = here("Study1", "Figures", "Analysis2_PreferentialLooking_Binary_Age.png"), plot = gp, dpi = 350, width = 5.5, height = 4.8) # Figure 2b(left)
